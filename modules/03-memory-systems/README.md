# Module 03: Memory Systems Short and Long Term
...
- Understand the core concepts of Memory Systems Short and Long Term
...
### What is Memory Systems Short and Long Term?

Memory Systems Short and Long Term is a fundamental component of AI Agent Framework: Zero to Hero. In production environments, this skill is used daily by engineers to build, deploy, and maintain reliable systems.

**Real-world analogy:** Think of Memory Systems Short and Long Term like learning to read a map before navigating a city. Once you understand the fundamentals, you can find your way through any complex system.
...
```bash
ls modules/03-memory-systems/lab/starter/
```
...
cd modules/03-memory-systems/lab/starter/
```

**Step 3:** Verify the setup
```bash
# Run the validation to check your setup
bash modules/03-memory-systems/validation/validate.sh
```
...
1. What is the main purpose of Memory Systems Short and Long Term?
...
- [ ] Validation script passes: `bash modules/03-memory-systems/validation/validate.sh`
...
**Next: [Module 04 →](../04-planning-and-reasoning/)**
