# Module 06: LangGraph Stateful Workflows
...
- Understand the core concepts of LangGraph Stateful Workflows
...
### What is LangGraph Stateful Workflows?

LangGraph Stateful Workflows is a fundamental component of AI Agent Framework: Zero to Hero. In production environments, this skill is used daily by engineers to build, deploy, and maintain reliable systems.

**Real-world analogy:** Think of LangGraph Stateful Workflows like learning to read a map before navigating a city. Once you understand the fundamentals, you can find your way through any complex system.
...
ls modules/06-langgraph-workflows/
```
...
```bash
ls modules/06-langgraph-workflows/lab/starter/
```
...
cd modules/06-langgraph-workflows/lab/starter/
```

**Step 3:** Verify the setup
```bash
# Run the validation to check your setup
bash modules/06-langgraph-workflows/validation/validate.sh
```
...
1. What is the main purpose of LangGraph Stateful Workflows?
...
- [ ] Validation script passes: `bash modules/06-langgraph-workflows/validation/validate.sh`
...
**Next: [Module 07 →](../07-crewai-multi-agent/)**
